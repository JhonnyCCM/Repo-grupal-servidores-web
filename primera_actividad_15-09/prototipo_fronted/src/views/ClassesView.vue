            ...
            <div class="p-4">
              ...
              <div class="space-y-2 mb-4">
                ...
                <div class="flex items-center text-gray-600">
                  ...
                  <span>{{ classItem.coach.fullName }}</span>
                </div>
                ...
                <div class="flex items-center text-gray-600">
                  ...
                  <span>{{ classItem.enrolledMembers }}/{{ classItem.capacity }}</span>
                </div>
              </div>

              <!-- Botón de reserva -->
              <button
                :disabled="!classItem.isActive || classItem.enrolledMembers >= classItem.capacity"
                :class="
                  classItem.isActive && classItem.enrolledMembers < classItem.capacity
              ...
              >
                {{
                  !classItem.isActive
                    ? 'No Disponible'
                    : classItem.enrolledMembers >= classItem.capacity
                      ? 'Clase Llena'
                      : 'Reservar Clase'
                }}
              </button>
